...
class MEGABYTE_Encoder(nn.Module):
    def __init__(
        self,
        *,
        num_tokens,
    ...
    def forward(self, ids, return_loss = False):
        ...
        memory = [] # both global and local feature to be used in decoder
        ...
        ## Chun hung:
        # as an encoder
        # attended size (b k p d) , to_logits embed to token space, (k p) merge to become t
        # suggest keep all p + 1 sequence, for attention in decoder
